...
- [x] **UI-09**: Global search screen with type and severity filters; results link to source entities
- [x] **UI-10**: Profile screen (edit email, change password, manage own API keys with one-time reveal, manage own S3 keys)
