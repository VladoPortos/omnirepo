...
| `git-conformance` | Phase 4 D-46 — real `git` client clone/push/pull against both `go-git/v6` and `gitkit` fallback backends |
| `bench-git` | Streaming-clone memory-ceiling benchmark (WR-07 D-42 gate) |
