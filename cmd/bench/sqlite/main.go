// Command bench-sqlite is the D-42 contention benchmark that pins pitfall
// P2: N goroutines hammer metadata.WriteTx for a duration, and the binary
// exits non-zero if any attempt surfaces SQLITE_BUSY / "database is locked".
//
// Default is 16 workers x 30s, matching the ROADMAP success-criterion gate.
// Override with --workers / --duration for dev-loop runs.
package main
