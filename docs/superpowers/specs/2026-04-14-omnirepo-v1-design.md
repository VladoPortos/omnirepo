...
|---|---|---|
| Docker/OCI | `/v2/<project>/<repo>/<image>/...` | `/v2/dxc/oracle/nginx/manifests/1.25` |
| S3 | `/s3/<bucket>/<key>` (+ virtual-host style) | `/s3/builds/artifact.tgz` |
| Git | `/git/<project>/<repo>.git/...` | `/git/dxc/infra.git/info/refs` |
| REST API | `/api/v1/...` | `/api/v1/projects/dxc/repos` |
| Swagger | `/api/docs` | |
| RPM | `/<project>/rpm/<repo>/...` | `/dxc/rpm/oracle/repodata/repomd.xml` |
| APT | `/<project>/deb/<repo>/...` | `/dxc/deb/internal/dists/stable/Release` |
| PyPI | `/<project>/pypi/<repo>/simple/...` | `/dxc/pypi/wheels/simple/requests/` |
| Helm | `/<project>/helm/<repo>/...` | `/dxc/helm/charts/index.yaml` |
| RAW | `/<project>/raw/<repo>/<path>` | `/dxc/raw/docs/readme.pdf` |
