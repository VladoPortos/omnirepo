...
//   - Lease released on goroutine panic — the subsequent
...
// cadence; 5 s deadline is generous (the PRAGMA
...
// return 409. Without this invariant, the lease-unwind path regresses silently.
