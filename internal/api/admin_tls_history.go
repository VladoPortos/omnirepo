// Package api — admin TLS certificate history endpoint.
//
...
// tlsHistoryEntry matches the frontend TLSHistoryEntry shape.
...
// version always returned an empty list.
...
// including fingerprint_sha256 and source.
