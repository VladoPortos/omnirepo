...
//
// Asserts the legacy-to-envelope normalization surface (writeJSONError →
// httperr.Write bridge) is code-regex-valid, class-inference-table-correct,
// and panic-safe at the bridge boundary.
//
...
// TestNormalizedCodesPassRegex is the regression gate. Each
...
// TestNormalizeLegacyCode_NeverLeaksShapeInternals is the gate
