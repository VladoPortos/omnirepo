...
func goodBootstrap() app.Bootstrap {
	return app.Bootstrap{
		...
		Projects: []app.BootstrapProject{
			{Name: "dxc", DescriptionMD: "d", Members: []string{"alice", "bob"}},
			{Name: "acme", Members: []string{"alice"}},
		},
		Repos: []app.BootstrapRepo{
			{Project: "dxc", Type: "docker", Name: "web"},
			{Project: "acme", Type: "rpm", Name: "pkgs"},
		},
		APIKeys: []app.BootstrapAPIKey{
			{OwnerKind: "user", Owner: "alice", Name: "alice-ci", Token: "omr_u_" + strings.Repeat("a", 28)},
			{OwnerKind: "project", Owner: "dxc", Name: "dxc-ci", Token: "omr_p_" + strings.Repeat("b", 28)},
		},
	}
}
...
func TestAtomicRollbackOnBadRepoType(t *testing.T) {
	db := sqlitetest.New(t)
	b := goodBootstrap()
	b.Repos = append(b.Repos, app.BootstrapRepo{Project: "dxc", Type: "bogus", Name: "x"})
	p := writeBootstrap(t, b)
...
func TestBootstrapValidationMatrix(t *testing.T) {
	...
	cases := []tc{
		...
		{"V10_DuplicateProject", func(b *app.Bootstrap) { b.Projects[1].Name = "dxc" }, "duplicate project"},
		...
		{"V15_RepoUniqueWithinProjectType", func(b *app.Bootstrap) {
			b.Repos = append(b.Repos, app.BootstrapRepo{Project: "dxc", Type: "docker", Name: "web"})
		}, "duplicate repo"},
