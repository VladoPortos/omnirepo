...
// audit_log table, which is the documented behaviour. Exactly one of
...
//
// Note: time.RFC3339Nano strips trailing zeros → variable width
...
// best-effort (logs slog.Warn on failure).
