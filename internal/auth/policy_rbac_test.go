...
// maintainerWriteActions is the D-20 list of 16 write actions that require
...
// memberReadActions is the D-21 list of 3 read actions that any member
...
// with role "viewer") is denied every D-20 write action with reason
...
// with role "viewer") is allowed every D-21 read action. PublicRead is
...
// (member of project 42 with role "maintainer") is allowed every D-20
// write action.
...
// membership map is denied D-20 actions with ReasonNotAProjectMember —
