...
// ProjectNameRegex is the project-name slug: must start with [a-z0-9],
...
// route prefix. The reserved set lives in internal/httpx so router
...
// the change-password and admin-reset paths accepted "abc".
