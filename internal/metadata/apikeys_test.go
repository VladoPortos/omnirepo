...
// TestAPIKeysRepo_RevokeProjectOwnedForProject pins the cascade.
...
// TestAPIKeysRepo_RestoreCascadedProjectOwnedForProject pins the
...
// going through ProjectsRepo.SoftDelete — the cascade also
...
// the cascade. Used only by lookup-hardening tests.
...
// TestAPIKeysRepo_FindByPrefixSha_DeletedProject pins that a
...
// lifecycle is out of scope here — user-owned keys MUST still
