...
// the OCI /v2 handler and the GC sweeper.
//
...
// (invariant: refcount moves with the row that references the blob,
// never lazily).
...
// the row is missing or ref_count is already 0.
