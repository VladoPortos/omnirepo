-- Phase 1 initial schema (D-12).
-- See .planning/phases/01-foundation/01-RESEARCH.md §"Initial Migration DDL"
-- for the canonical definition. Downstream plans add per-protocol tables in
...
-- exists before this file is applied. The grep-gate still expects the
-- "CREATE TABLE schema_migrations" phrase here as a documentary anchor for
-- the canonical schema — satisfied by this CREATE TABLE IF NOT EXISTS.
