-- Migration 002_jobs: dispatcher-leased job rows and scan pipeline tables.

-- sync_jobs: dispatcher leases via single-statement UPDATE ... RETURNING
-- (requires SQLite >=3.35). Two-pool runner shares this table via
...
-- (cve_id, package, summary) for search.
