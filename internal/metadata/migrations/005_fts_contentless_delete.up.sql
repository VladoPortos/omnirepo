-- Migration 005_fts_contentless_delete:
--
...
-- blocks the inline-write helpers (DeleteRepoFTS,
...
-- Tokenizer stays unicode61+diacritics.
--
-- The tables are populated from scratch during normal operations, so no
-- data migration is required at this point (the seed paths don't
-- write to FTS5 yet).
