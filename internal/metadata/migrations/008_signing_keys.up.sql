-- Phase 3 migration 008_signing_keys (Plan 03-01, D-01..D-05):
--
-- Per-repo OpenPGP signing keypair store. private_enc is AES-GCM-encrypted
-- via internal/crypto/aead.go (D-03). One row per (repo_id, scope='repo')
-- — every APT/RPM repo owns its own RSA-4096 key (D-01). Only
