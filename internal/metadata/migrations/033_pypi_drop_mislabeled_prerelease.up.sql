-- F-07.5 (post-v1.4): drop pypi_files + pypi_fts rows whose stored
...
-- a non-digit-led version (Codex review, post-v1.4 — restricting to
-- kind='sdist' via EXISTS correlation).
