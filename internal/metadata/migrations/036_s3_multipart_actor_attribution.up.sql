...
-- fabricating a user (audit finding #10). Backfill is NOT required —
-- REQUIREMENTS S3HARD-05 confirms no committed multipart rows pre-v1.6 in
-- any deployment.
--
