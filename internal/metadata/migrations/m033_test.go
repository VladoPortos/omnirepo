...
// TestMigration033_DropsMislabeledPrerelease verifies the backfill.
//
...
func TestMigration033_DropsMislabeledPrerelease(t *testing.T) {
	...
	seed("sdist", "rc1", "widget-1.0.0-rc1.tar.gz", "sha256:rc1")         // broken
	...
	// The EXISTS correlation in the FTS delete must NOT touch pypi_fts
	// rows tied to wheels even when they share a letter-led version shape
	// with a deleted sdist.
