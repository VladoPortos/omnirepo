...
//
// This is the schema shape that lets the server attribute multipart uploads
// to the resolved S3 access key without fabricating a user.
...
func TestMigration036_DownUpRoundtrip(t *testing.T) {
	...
	// Apply 036.down.sql directly (runner has no revert path).
