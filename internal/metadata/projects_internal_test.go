...
// stability guarantees and exists only to prove LIFECYCLE-04 atomicity.
package metadata
...
// TestProjectsRepo_SoftDelete_Atomicity — MANDATORY proof of LIFECYCLE-04.
...
// cascade can half-commit, every other guarantee in this phase collapses.
