...
// -----------------------------------------------------------------------------
// Repos.SoftDelete prunes FTS; Repos.Restore reindexes from base tables;
// Repos.SoftDelete is idempotent.
// -----------------------------------------------------------------------------
...
// --------------------------------------------------------------------------
// Update + WipeDocker + WipeRaw helpers.
// --------------------------------------------------------------------------
...
// --------------------------------------------------------------------------
// Upstream-mirror columns round-trip.
// --------------------------------------------------------------------------
...
// via FindByTriple and ListByProject. Guards migration 024.
