...
// Plan 02-02 transitional fallback wrapper at multipart.go:91-95) carries a
...
// an unattributed multipart row, defeating audit (S3HARD-05 motivation).
...
// SCAN path used by the boot-recovery sweeper (Plan 02-03).
