...
// Mirrors SyncJobsRepo's lease pattern — single-statement
...
// MarkFailed records err and schedules a retry at nextRunAt.
//
...
// hit before. Format explicitly to the SQLite-native shape so retries
