...
// keypair table (Phase 03 Plan 01, D-01..D-05). The private key is
// AES-GCM-encrypted at rest via internal/crypto AEAD (D-03); the struct
// returned by Lookup deliberately has no private bytes field so no
// accidental echo back to REST or logs is possible. Only LookupPrivate
// decrypts, and it is reserved for the regen goroutine.
package metadata
