...
// upstream-credentials store. Secrets (password, token) are
...
// password and token empty. At least one secret is mandatory.
...
// as 404 (cross-project protection).
...
// Update replaces username and re-encrypts a fresh secret. The full
...
// id. Used by cross-project validation: when
...
// at pull-external time — never by REST responses. Callers
