...
// TestDEBPackagesFilenamePreservesPoolPath covers that Packages.gz must
...
// TestDEBGetServePackagePercentEncoded covers that apt percent-encodes `+`
...
// --------------------------------------------------------------------------
// MirrorGuard rejects uploads on is_mirror=1.
// --------------------------------------------------------------------------
