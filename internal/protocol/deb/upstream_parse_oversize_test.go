...
// Plan 05-03 STREAMIO-06 (audit #5): deb upstream_parse must fail-explicit
// with streamio.ErrMetadataTooLarge whenever an upstream serves cap+1
// bytes for the raw HTTP body (Release / Packages(.gz)) OR for the
// gunzipped Packages stream.
