// Package git implements the LFS refusal handler.
//
// Git LFS is not supported by OmniRepo. Because go-git has no LFS
...
//     invariant (LFS pointer bypass).
//
// Resolution: return 501 Not Implemented with envelope code
