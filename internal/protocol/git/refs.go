// Package git — refs walker for the post-ReceivePack hook and ref
// classification. Opens the bare repo via go-git PlainOpen, iterates
...
// HEAD → "symbolic" (covers both symbolic and detached HEAD as a
...
// held. Returns an error if the repo cannot be opened or the DB
