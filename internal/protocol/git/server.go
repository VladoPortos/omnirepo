...
// two Smart-HTTP backends (gogit primary, gitkit fallback) per Phase 4 D-25.
//
// Plan 10 middleware consumes Handler(repoPath) once auth/membership/mutex
...
type GitServer interface {
	...
	// parameterization (D-46).
	BackendName() string
}

// InitBare creates an empty bare repo at repoPath with HEAD symbolic-ref
// pointing at refs/heads/<initialBranch>. Called by Plan 12's repo-create
// hook (D-38). Intermediate directories are created with 0o755.
//
