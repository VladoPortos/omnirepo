...
// Live E2E: mirror a real public GitHub HTTPS repo end-to-end.
//
...
//
// Scope guard: keep to a single end-to-end scenario.
//
...
// prove correctness; this test only proves real-network plumbing works
// end-to-end against a real Git server.
//
// Pitfall: the SyncHandler's TLS/CA/proxy/
...
// liveGitDefaultUpstream is a small, stable, LFS-free public GitHub repo
// (~4 MB, pure Python, stable since 2014). Operators can override via
// LIVE_GIT_UPSTREAM.
