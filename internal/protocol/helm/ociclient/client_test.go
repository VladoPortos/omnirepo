...
// TestPullChart_LegacyMediaType proves OCIHELM-07 / INV-11-01-02:
// application/tar+gzip layer media type is accepted and no warning leaks.
...
// prod impl pins to io.Discard (INV-11-01-02 enforced by grep in the
// verify step). We do NOT actually redirect os.Stderr — doing so
// portably on Linux under go test requires dup2 + os.Pipe plumbing
