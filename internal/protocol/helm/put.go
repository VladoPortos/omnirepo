...
//   - <name>-<ver>.tgz.prov (or *.prov) → provenance pass-through
...
func (h *Handler) put(w http.ResponseWriter, r *http.Request) {
	...
	if !h.requireRepoWrite(r.Context(), actor, res.project.ID, auth.ActionHelmUpload) {
...
// putProvenance implements the .prov pass-through path. No parse,
