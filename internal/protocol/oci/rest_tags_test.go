...
// TestDeleteTag_LastTag_CascadesToManifestDelete verifies the REST
...
func TestDeleteTag_SiblingTagKeepsManifest(t *testing.T) {
	...
	if m == nil {
		t.Fatalf("manifest cascaded away despite v2 still pointing at it — sibling-tag guard broken")
	}
