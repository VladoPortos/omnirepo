// Package pypi implements the PyPI protocol surface. PEP 503 Simple HTML
// index, PEP 691 JSON variant via content negotiation, canonical
// project-name normalization, twine legacy multipart upload at /legacy/,
// PEP 694 upload session state machine at /+upload/, wheel/sdist metadata
// parsing, and /simple/ regen via the coalescer.
package pypi
...
// Normalize returns the PEP 503 canonical form of a project name:
//
