...
// regexp" is required. Future contributors must NOT migrate this to a
// backtracking engine (PCRE, etc.).
//
...
// (no dedup across distinct filename spellings).
...
// at the mirror boundary by isSafeMirrorFilename) are Go-escaped
