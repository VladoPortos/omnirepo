...
// upstream_parse_test.go. The black-box regression covered the three
// canonical forms (bare, /simple, /simple/) but not sub-path mirrors or
// hostnames that happen to contain the substring "simple".
