...
// Post-v1.4 — F-07.5 + F-07.6 regression guards for the mirror sync path.
//
// F-07.5 locked: a sdist filename with a dashed pre-release suffix
...
//
// F-07.6 locked: a hostile upstream filename (path separator / control
...
//   - widget-1.0.0-rc1.tar.gz — F-07.5 regression guard
//   - widget-1.0.0.tar.gz     — canonical control case
//   - widget/../escape.tar.gz — F-07.6 allowlist guard (must be dropped
...
// TestMirrorSync_PyPI_DashedPrereleaseVersion — F-07.5. Locks the
// sync-handler reroute through parseSdistFilename so
// `widget-1.0.0-rc1.tar.gz` stores version=`1.0.0-rc1` (not `rc1`).
...
// TestMirrorSync_PyPI_HostileFilenameRejected — F-07.6. The collect-pass
