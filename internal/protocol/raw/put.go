...
func (h *Handler) put(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		// Never surface internal driver/path messages to the client — log
		// them server-side and return an opaque 500.
...
// or "" when unknown. The caller falls back to http.DetectContentType.
