...
// we depend on. The Backend interface has 12 required methods:
...
// and PutObject takes an extra *PutConditions parameter for conditional writes.
//
// The S3 handler CAN use the embedded MultipartBackend surface. No
...
// silently ignores files starting with '_' or '.'.
