...
// Plan 02-03 Task 2 — interceptPutObject middleware tests.
//
// Coverage matrix (per <behavior> in 02-03-PLAN.md):
//
//   T1 HexMismatchRejects               — 400 + AWS envelope; next NEVER called; no file at dst
//   T2 PreExistingObjectSurvives (B-2)  — pre-staged "v1" at dst stays "v1" byte-for-byte after rejection
...
import (
	...
	s3 "github.com/dxc-internal/omnirepo/internal/protocol/s3"
...
// TestInterceptPutObject_PreExistingObjectSurvives (T2 — B-2 destructive-overwrite fix)
//
