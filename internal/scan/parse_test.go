...
// Trivy misconfiguration findings (Helm/IaC scans) must be
...
// An active Trivy misconfig with no Status field must
...
// Vulnerabilities and misconfigurations cohabit in the
