// Package scan — severity gate in-memory cache (D-26, Pitfall 6).
//
...
// marks the scan done (T-02-09-02) so a stale "allow" entry never persists
// past a fresh high-severity scan.
package scan
