...
// call.
//
// Hot-reload (D-14, D-15) is implemented by passing CertHolder.Get as
...
// use as OmniRepo's first-boot TLS identity (D-14). The SAN list always
...
// size (2048 and 4096 are the realistic choices; plan 01-05 pins 4096 for
// first boot).
