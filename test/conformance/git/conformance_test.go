...
// TestGitConformance is the top-level Git conformance suite.
...
// full matrix: clone, push, fetch, oversize-push gate, project-auth
	...
	for _, backend := range backends {
		t.Run(backend, func(t *testing.T) {
			...
			t.Run("OversizePushRejected", func(t *testing.T) {
				...
				// Git CLI output must contain the oversize-push error message.
