...
type gitFixture struct {
	...
	// Project API key for the project-auth variant (project:<proj>:<omr_p_...>).
...
// The backend parameter selects "gogit" or "gitkit".
func bootAppWithGitRepo(t *testing.T, backend string) *gitFixture {
	...
	// Generate a project API key for the project-auth variant.
