...
func TestDNFInstallFromOmniRepo(t *testing.T) {
	...
	// The RPM PUT handler enforces filename ==
	// "<name>-<version>-<release>.<arch>.rpm" (canonical NEVRA) to prevent
	// metadata/disk drift. sample.rpm is the centos-release-7 fixture; use
	// its NEVRA as the upload filename.
