...
This package holds end-to-end user-acceptance tests for Phase 2 that drive
the full omnirepo binary against **real external clients** and **real
upstream registries** (Docker Hub). It closes the five UAT items flagged
by the Phase 2 verifier (`.planning/phases/02-oci-raw-scan-pipeline/02-VERIFICATION.md`).
