/**
 * Phase 10 / plan 10-04 — DBHealthCard (7th composition-row card, super-
 * admin only) e2e coverage.
 *
 * Six scenarios per plan <behavior>:
 ...
 * payload — integration of the REAL backend with the full UI landed in
 * plan 10-03; this spec focuses on the frontend rendering contract.
 *
