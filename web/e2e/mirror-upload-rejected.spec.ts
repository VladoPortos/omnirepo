/**
 * mirror-upload-rejected Playwright coverage.
 *
...
test.describe('Mirror upload rejection', () => {
  ...
  test('APT push to mirror repo returns 403 envelope with code=repo_is_mirror', async ({
    ...
    // explicitly so we exercise the guard path.
    ...
    // Envelope code is the dotted repo.repo_is_mirror form; the
    // assertions rely on the substring "repo_is_mirror" resolving.
