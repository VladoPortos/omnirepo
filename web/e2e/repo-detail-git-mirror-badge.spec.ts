/**
 * Playwright coverage for the Read-only mirror badge + push-instruction
 * hiding on the Git repo detail page.
 *
...
test.describe('Repo detail: Git mirror badge + push hide', () => {
