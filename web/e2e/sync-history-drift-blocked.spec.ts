/**
 * v1.7 SyncHistoryDialog percent-threshold override flow.
 *
...
test.describe('SyncHistoryDialog drift-blocked override flow', () => {
  ...
  test('absent banner when no job carries drift_blocked', async ({
    ...
    // The drift_purged sub-line should still render.
