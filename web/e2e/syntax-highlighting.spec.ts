/**
 * FRONTFIX-03 (Phase 07) — verify Shiki syntax highlighting works in
 * the *production* SPA build for the Git file viewer.
 *
 * Why this exists
 * ----------------
 ...
 * elements) were absent. The repaired implementation (FRONTFIX-01)
 * uses an explicit static-import map; this spec is the regression
 * guard that proves the Vite build emits real language chunks and
 * the runtime can actually load + apply them.
 *
 * Test strategy
 * --------------
