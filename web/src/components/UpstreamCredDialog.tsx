/**
 * UpstreamCredDialog — Phase 8 Plan 05 (MIRROR-22, MIRROR-23).
 *
 ...
 *             preserves the existing secret (T-08-05-03).
 *
 * Security properties:
 ...
 *     ErrorEnvelopeRenderer inline per Phase 6 ERR invariants.
 *
...
export function UpstreamCredDialog({
  ...
  const handleSubmit = () => {
    ...
    if (mode === 'edit' && cred) {
      ...
      // the backend preserves the existing secret (T-08-05-03). Do NOT
      // send `""` — strip the key.
