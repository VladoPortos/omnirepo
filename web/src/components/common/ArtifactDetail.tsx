 ...
 * content page. Renders a deterministic two-column metadata grid plus an
 * optional scan-findings strip and a download button. Keeps the visual
 * language consistent across RPM / DEB / docker / pypi / helm / raw so
 * users see the same shape everywhere.
 */
