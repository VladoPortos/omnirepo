 ...
 *
 * Uses the 8px (right-2 top-2) inset. The 6px carve-out is grandfathered
 * ONLY to the two v1.0 files where it already appears (SnippetPanel,
 * OneTimeReveal); any new placement MUST use 8px.
 *
 * Props:
 ...
 *             reveals length (<=32) but not content.
