/**
 * Reusable sortable table component wrapping shadcn Table.
...
interface DataTableProps<T> {
   ...
   * inside the container instead of pushing the whole page (admin-table
   * pattern). Consumers with 6+ columns opt in; narrow tables (<6 cols)
   * leave it off to avoid unnecessary chrome.
   */
  stickyFirstColumn?: boolean;
  onRowClick?: (row: T) => void;
  /**
   * Accordion detail row. When both isRowExpanded(row) returns true AND
   * renderExpanded is provided, the table inserts a full-width <tr>
