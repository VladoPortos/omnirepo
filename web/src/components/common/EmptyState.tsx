/**
 * EmptyState — shared empty-data surface.
 *
 * Props API is fixed. Borderless, centered, muted-foreground. Callers wrap
 * in <Card> if they need panel chrome.
 *
 * a11y contract:
...
export interface EmptyStateProps {
  icon?: LucideIcon;
  title: string;
  /** ReactNode (not string) so callers can embed example chips inline. */
  description?: ReactNode;
  primaryCTA?: EmptyStateCTA;
  /** Inline SnippetList slot only — rendered between description and CTA. */
  children?: ReactNode;
  className?: string;
}
