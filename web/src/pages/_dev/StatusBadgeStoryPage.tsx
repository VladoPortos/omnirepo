 ...
 * the Phase 6 StatusBadge primitive:
 ...
 * `data-story-icon-only` attributes on a wrapping div so plan 06-08's
 ...
 * gate established by ErrorClassStoryPage (plan 06-03) and
 * PrimitivesStoryPage (plan 06-06). Production builds tree-shake the
 * entire module — acceptance gate is `grep StatusBadgeStoryPage
 * web/dist/assets/*.js` returning zero matches.
 *
 * Phase 6 / plan 06-07 task 3.
 */
    ...
    >
      <header className="space-y-1">
        ...
        <p className="text-xs text-muted-foreground">
          6 statuses × 2 sizes × 2 iconOnly values = 24 variants. Plan
          06-08 Playwright suite snapshots this page as a single
