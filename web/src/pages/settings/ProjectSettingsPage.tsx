 ...
 * ProjectSettingsPage.
 *
 * Page mounted at /projects/:name/settings. Hosts project-scope
 * settings as a Tabs surface; currently ships just the Upstream
 * credentials tab. Other project settings (members, general) continue
 * to live on ProjectDetailPage until a future rework moves them here.
 *
 * URL-param decoding: `useParams()` returns the raw route match, which
 * is the URL-encoded slug; we decodeURIComponent before using it as a
 * project name.
 *
